...
// ============================================================
// Absorbe : observability-agent, resilience-agent, prompt-versioning-agent
//
// Usage:
...
// Groq pricing (llama-3.3-70b-versatile) en $ / 1M tokens
...
function cmdCost() {
  ...
  for (const t of traces) {
    const inp = t.prompt_len  / 4; // ~4 chars/token
